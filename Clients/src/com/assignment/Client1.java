...
/**
 * The class is responsible for Client 1 operations.
 * 
 * @author Tanveer
 *
 */
public class Client1 extends JFrame {
	...
	private static Client1 frame = null;
	 ...
	 */
	private Client1(String id, int time) throws UnknownHostException, IOException {

		logicalTime = time;

		String[] users = { "User 2", "User 3" };
		...
		Runnable sendMessage = () -> {
			try {
				while (true) {
					...
					Message message = new Message("User 1", users[random.nextInt(2)], Integer.toString(logicalTime));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Message message = new Message("User 1", null, "REQUEST_TO_CONNECT");
				try {
		...
		scrollPane.setBounds(29, 149, 555, 328);
